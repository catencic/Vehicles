...
namespace Vehicles.API.Migrations
{
    ...
    [Migration("20210919212621_CompleteTheDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vehicles.API.Data.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Vehicles.API.Data.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Vehicles.API.Data.Entities.Vehicle", b =>
                {
                    ...
                    b.HasOne("Vehicles.API.Data.User", "User")
                        .WithMany("Vehicles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
